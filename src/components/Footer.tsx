      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 pb-10 border-b border-gray-700">
          <div className="lg:col-span-2">
            <img 
              ...
              alt="Serene Lanka Travel Logo" 
              className="h-16 w-70 mb-6 invert" 
            />
            <p className="text-gray-300 mb-6">
              Crafting Sri Lankan adventures with local expertise. Your journey starts here. 🍃🌴🌎
            </p>
            <p className="text-gray-300 mb-6">
              katunayake,<br />
              Sri lanka.
            ...
            <div className="flex space-x-4">
            <a
              href="https://www.facebook.com/serenelankatravel"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-300 transition-colors hover:bg-gray-700 hover:text-white"
            >
            ...
            <a
              href="https://twitter.com/wrldstechnologies"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-300 transition-colors hover:bg-gray-700 hover:text-white"
            >
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Serene Lanka Travel. All rights reserved.
          </p>
