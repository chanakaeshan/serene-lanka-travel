...
const TravelPackages = () => {
  ...
  return (
    <section id="packages" className="py-16 bg-gradient-to-b from-travel-sky/20 to-white">
      <div className="container mx-auto px-4">
        ...
        {featuredPackage && selectedCategory === "All" && (
          <div className="mb-16">
            <h3 className="text-2xl font-bold mb-6 text-center text-gray-900">Featured Package</h3>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl p-8">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Let us create a custom travel experience tailored to your preferences, budget, and travel dates.
            </p>
