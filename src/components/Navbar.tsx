...
const Navbar = () => {
  ...
  return (
    <motion.nav className={cn("fixed top-0 left-0 right-0 z-50 transition-all duration-300 w-full", isScrolled ? "bg-white shadow-sm" : "bg-green-900")} initial={{
      opacity: 1,
      y: 0
    }} animate={{
      opacity: 1,
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <ul className="grid gap-3 p-4 w-[400px]">
                      <li>
                        <Link to="/PhotoGallery" className="block p-3 space-y-1 rounded-md hover:bg-gray-100">
                          <div className="font-medium">Gallery</div>
                          <p className="text-sm text-gray-500">Smart textiles for firefighter safety</p>
                        </Link>
                      </li>
                      <li>
                        <Link to="/Packages" className="block p-3 space-y-1 rounded-md hover:bg-gray-100">
                          <div className="font-medium">Packages</div>
                          <p className="text-sm text-gray-500">Advanced tracking for athletes</p>
                        </Link>
                      </li>
                      <li>
                        <Link to="/blogs" className="block p-3 space-y-1 rounded-md hover:bg-gray-100">
